...
uses
  ...
  FMX.MediaLibrary.Actions, FMX.StdActns, FMX.DateTimeCtrls, FMX.Ani, System.Math;
...
procedure TFrm_Principal.CalcContentBoundsProc(Sender: TObject;
  var ContentBounds: TRectF);
begin
...
begin
        ...
        TabControl.TabPosition := TTabPosition.None;
         ...
         VertScroll.OnCalcContentBounds := CalcContentBoundsProc;

end;

procedure TFrm_Principal.FormFocusChanged(Sender: TObject);
begin
UpdateKBBounds;
end;
...
procedure TFrm_Principal.FormVirtualKeyboardHidden(Sender: TObject;
  KeyboardVisible: Boolean; const [Ref] Bounds: TRect);
begin
...
procedure TFrm_Principal.FormVirtualKeyboardShown(Sender: TObject;
  KeyboardVisible: Boolean; const [Ref] Bounds: TRect);
begin
...
procedure TFrm_Principal.RestorePosition;
begin
    VertScroll.ViewportPosition := PointF(VertScroll.ViewportPosition.X, 0);
  MainLayout1.Align := TAlignLayout.Client;
  VertScroll.RealignContent;
end;

procedure TFrm_Principal.UpdateKBBounds;
var
  LFocused : TControl;
  LFocusRect: TRectF;
begin
  ...
  begin
    ...
    LFocusRect.Offset(VertScroll.ViewportPosition);
    ...
    begin
      ...
      VertScroll.ViewportPosition :=
     PointF(VertScroll.ViewportPosition.X,
