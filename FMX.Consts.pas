...
resourcestring
  ...
  { Error Strings }
  SInvalidPrinterOp       = 'Operação não suportada na impressora selecionada';
  ...
  SMsgGooglePlayServicesNeedUpdating = 'Os Serviços do Google Play precisam ser atualizados. Acesse a Play Store para atualizar '
    + ' Google Play Services, reinicie o aplicativo';
const
{$IFDEF MACOS}
